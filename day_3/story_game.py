...
# 1
# 'You leave the town and continue your journey, but not this quest!' 1.0
...
# 'Do you agree?'
# 'Yes, I will help.' 0.0.0
# 'I`ll go my own way.' 0.0.1
...
# 'No time for doubts, I`ll save him!' 0.0.0.1
# 'I cannot just leave all my possessions this way...' 0.0.0.0
...
# 'Yes, it seems friendly, why not.' 0.1.0
# 'It is a distraction, I won`t go.' 0.1.1

# 0.0.0.0
# 'You both drown, and it is the end of your story...' 1.0
...
# 'Maybe they`ll guide me? I`ll check.' 0.0.1.0.1
# 'No, I should not be distracted.' 0.0.1.0.0
...
# Congratulations, you got your reward and finished this quest! See ya, adventurer!' 1.1

# 0.1.0
# 'You follow the dog and it leads you to the grove, where you might find the tree!' 0.0.1.0
...
# 'No, this may be dangerous, what if it is a trap?' 0.1.1.1
# 'Yes, I don`t think it is suspicious.' 0.1.1.0

# 0.1.1.1
# 'You go deeper and deeper into the forest.
# You got lost and never came back, nobody knows what has happened to you.' 1.0

# 0.1.1.0
# 'You come closer, violet light goes off, and you see the grove, where the tree might be.' 0.0.1.0
...
# 'Maybe there is loot? I`ll open it.' 0.0.1.1.0
# 'No, I won`t.' 0.0.1.1.1

# 0.0.1.1.0
# 'You try opening the chest, but suddenly something tong-like comes out of it and grabs you.
# You are the mimic`s prey. Sorry, the quest ends here...' 1.0

# 0.0.1.1.1
# 'You sit in front of a harp and enjoy the enveloping song, it clouds your mind and feels so good.
# You have nothing to worry about anymore, you go back to the town and forget about the tree treasure.' 1.0
