...
SCENARIO = {
    ...
    '0': {
        'text': 'The man takes you to the road that will lead you to a tree with the hidden treasure and shows you '
                'the direction. Then he leaves. After walking down the road for a while you see the fork at your path. '
    ...
    '00': {
        'text': 'You walk the path to the lake shore and enjoy the weather and fresh water. You can see a boat, '
                'sailing in your direction. An old man asks you to do him a small favour and he`ll give you'
    ...
    '000': {
        'text': 'You get on the boat and the man asks you to help him draw two nets from the water. '
                'You manage doing this, and you sail along the shore. As the boat begins to shake and'
                ' the water fills it from the inside, you start drowning. You now have a choice:'
                ' save an old man or grab your belongings and try to rescue. What will you choose?',
    ...
    '01': {
        'text': 'You start making the way through the forest, following the narrow trail. Some time later'
    ...
    '001': {
        'text': 'Walking along the shore for quite a long time, you find a road leading to a grove, and you think '
    ...
    '011': {
        'text': 'You ignore the dog and go on searching the way. There is an opening in the trees wall '
